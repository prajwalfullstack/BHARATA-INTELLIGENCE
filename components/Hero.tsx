          ...
          <div className="flex flex-col items-start text-left">
            ...
            >
              <div className="relative group w-full sm:w-auto">
                ...
                <Button size="lg" className="relative w-full sm:w-auto h-14 text-base bg-primary hover:bg-[#184a30] shadow-xl shadow-primary/20 border-0 rounded-xl flex items-center justify-center gap-2">
